...
class ReplyCommentValidator
{
    public function __construct($videoRepo, $commentRepo)
    {
    ...
    public function store($data, $videoID, $commentID)
    {
        ...
        $comment = $this->comment->findWhere(['uuid' => $commentID, 'video_id' => $videoID])->first();
        if(!$comment)
        {
